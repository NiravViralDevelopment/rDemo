                        ...
                        <form method="POST" action="{{ route('bookings.update', $booking->id) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="property_id" class="form-select" required>
                                        @foreach($properties as $property)
                                            <option value="{{ $property->id }}" {{ (string) old('property_id', $booking->property_id) === (string) $property->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="full_name" class="form-control" value="{{ old('full_name', $booking->full_name ?: $booking->customer_name) }}" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="start_date" class="form-control" value="{{ old('start_date', optional($booking->start_date)->format('Y-m-d')) }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Total Amount</label>
                                    <input type="text" name="total_amount" class="form-control amount-only" inputmode="decimal" autocomplete="off" value="{{ old('total_amount', $booking->total_amount) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Description</label>
                                    <textarea name="description" class="form-control" rows="3">{{ old('description', $booking->description) }}</textarea>
                                </div>
                            </div>
