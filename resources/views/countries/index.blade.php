            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">Code :</span> {{ $item->code }}</td> 
                        <td><span class="mobileShow">Country :</span> {{ $item->country_name }}</td> 
                        <td>
                            <div class="ThreeBtns">
                            <a href="{{ route('countries-edit',$item->id) }}" class="bi bi-pencil-square btn btn-outline-primary btn-sm"></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
        ...
        buttons: [
            ...
            // },
            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "{{ route('countries-create') }}";  // Redirect to the order creation route
                }
            }
        ],
        language: {
