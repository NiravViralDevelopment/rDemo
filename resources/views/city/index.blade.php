            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">Country :</span> {{ $row->countries->country_name }}</td>
                        <td><span class="mobileShow">State :</span> {{ $row->state->city_name }}</td>  
                        <td><span class="mobileShow">City :</span> {{ $row->city_name }}</td> 
                        <td>
                            <div class="ThreeBtns">
                            <a href="{{ route('city-edit',$row->id) }}" class="bi bi-pencil-square btn btn-outline-primary btn-sm"></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
        ...
        buttons: [
            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "{{ route('city-create') }}";  // Redirect to the order creation route
                }
            }
        ],
        language: {
