    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Bank Payment</h5>
                        ...
                        <form method="POST" action="{{ route('banks.transactions.update', [$bank->id, $transaction->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="gst_number" class="form-control" value="{{ old('gst_number', $transaction->gst_number) }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">GST %</label>
                                <input type="number" step="0.01" min="0" max="100" name="gst_percent" class="form-control" value="{{ old('gst_percent', $transaction->gst_percent) }}">
                            </div>
                            <div class="mb-3">
